    ...
    return (
        <>
            ...
            <section className='flex flex-col sm:flex-row sm:mt-16 bg-[#2c3f5e] w-full sm:p-8 sm:px-32'>
                ...
                <div ref={video} className={`w-full grow-0 shrink aspect-video order-first sm:order-last`}>
                    <iframe className={`${stick ? 'fixed top-16 left-0' : ''} z-30 w-full aspect-video`} src={`https://www.youtube.com/embed/${courseData.youtubeId}?autoplay=1`} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    {/* hidden sm:flex */}
                </div>
            </section>
...
export default CourseMobisoMobilePage